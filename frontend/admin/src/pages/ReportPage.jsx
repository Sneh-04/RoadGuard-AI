    ...
    <div className="space-y-6 pb-28">
      <Card title="Help protect the next driver" subtitle="Report road hazards in just a few taps">
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          <button className="flex items-center justify-center gap-3 rounded-[1.75rem] border border-emerald-300/15 bg-white/5 px-5 py-4 text-left transition duration-300 hover:border-emerald-300/30 hover:bg-white/10">
      ...
      <div className="grid gap-6">
        <Card title="Description" className="p-6">
          <textarea
            className="min-h-[160px] w-full rounded-[1.5rem] border border-white/10 bg-[#081b1a] p-4 text-slate-100 outline-none transition duration-300 focus:border-cyan-300/40 focus:ring-4 focus:ring-cyan-300/10"
      ...
      <div className="flex justify-center">
        <button className="inline-flex items-center justify-center rounded-[2rem] bg-[#14b8a6] px-8 py-4 text-sm font-semibold text-slate-950 shadow-[0_18px_40px_rgba(20,184,166,0.24)] transition duration-300 hover:bg-[#0fb19f]">
          Report Hazard
        </button>
      </div>
    </div>
