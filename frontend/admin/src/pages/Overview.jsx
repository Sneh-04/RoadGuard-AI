    ...
    <div className="space-y-6">
      ...
      <div className="rounded-[1.75rem] border border-white/10 bg-[#0f2f2f]/80 p-5 text-slate-100 shadow-sm">
        <div className="flex flex-wrap items-center gap-3">
          <span className={`rounded-full px-3 py-1 text-xs ${socketStatus === 'connected' ? 'bg-teal-500/15 text-teal-200' : socketStatus === 'connecting' ? 'bg-amber-500/15 text-amber-200' : 'bg-red-500/15 text-red-200'}`}>
