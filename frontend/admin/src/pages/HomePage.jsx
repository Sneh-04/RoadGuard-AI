    ...
    <div className="space-y-6 pb-28">
      <header className="rounded-[2rem] border border-white/10 bg-[#102f2f]/90 p-6 shadow-[0_35px_80px_rgba(20,184,166,0.14)] backdrop-blur-xl">
        <div className="flex items-start justify-between gap-4">
          <div>
            <p className="text-sm uppercase tracking-[0.3em] text-teal-200/70">Road Safety Assistant</p>
          ...
          <div className="inline-flex h-14 w-14 items-center justify-center rounded-[1.5rem] bg-white/5 text-teal-200 shadow-[0_20px_60px_rgba(0,201,167,0.18)]">
      ...
      <div className="grid gap-6 sm:grid-cols-2">
        <Card title="Slippery Roads ⚠️" subtitle="Current weather and slick conditions">
          <div className="flex items-center justify-between gap-4">
            ...
            <div className="flex h-20 w-20 items-center justify-center rounded-[1.75rem] bg-teal-500/10 text-teal-200">
        ...
        <Card title="Live hazard stream" subtitle={liveSummary}>
          <div className="flex items-center justify-between rounded-[1.75rem] border border-white/10 bg-white/5 px-4 py-4 text-slate-400">
            <div>
              ...
              <p className={`mt-2 font-semibold ${socketStatus === 'connected' ? 'text-teal-300' : 'text-amber-300'}`}>
                {liveCardLabel}
              </p>
            </div>
