      ...
      <Card title="Plan Safe Route" subtitle="Find the clearest path and avoid hazards">
        <div className="grid gap-4 sm:grid-cols-[1fr_auto]">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button className="rounded-[1.75rem] bg-cyan-400/10 px-4 py-3 text-sm font-semibold text-cyan-100 transition duration-300 hover:bg-cyan-400/20">Plan Safe Route</button>
          </div>
        </div>
      </Card>
