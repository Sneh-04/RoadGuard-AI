  ...
  return (
    <div style={{ background:'rgba(37,99,235,0.06)', border:'1px solid rgba(37,99,235,0.15)', borderRadius:20, padding:18 }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        <div>
          <p style={{ fontSize: 14, color: '#7dd3c7', margin: 0 }}>Road Condition</p>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
        ...
        <div>
          <p style={{ fontSize: 14, color: '#7dd3c7', margin: '4px 0' }}>{weather?.current || 'Sunny'}</p>
          <p style={{ fontSize: 14, color: '#7dd3c7', margin: '4px 0' }}>Humidity {weather?.humidity || 52}%</p>
          <p style={{ fontSize: 14, color: '#7dd3c7', margin: '4px 0' }}>Wind {weather?.windSpeed || 10} km/h</p>
        </div>
      </div>
    </div>
  );
